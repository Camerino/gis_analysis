...
datasource = mapnik.Shapefile(file="/home/alimjan/develop/shapefiles/TM_WORLD_BORDERS-0.3/" + 
...
map = mapnik.Map(MAP_WITH, MAP_HEIGHT, "+proj=longlat +datum=WGS84")
map.background = mapnik.Color("#8080a0")
map.append_style("PolygonStyle", polygonStyle)
map.append_style("LabelStyle", labelStyle)

map.layer.append(polygonLayer)
map.layer.append(labelLayer)
